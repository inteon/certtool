...
type ExtensionSubjectAlternativeName struct {
...
func (x *ExtensionSubjectAlternativeName) Reset() {
	*x = ExtensionSubjectAlternativeName{}
...
func (x *ExtensionSubjectAlternativeName) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ExtensionSubjectAlternativeName) ProtoMessage() {}

func (x *ExtensionSubjectAlternativeName) ProtoReflect() protoreflect.Message {
	mi := &file_extension_2_5_29_17_subject_alternative_name_proto_msgTypes[0]
...
// Deprecated: Use ExtensionSubjectAlternativeName.ProtoReflect.Descriptor instead.
func (*ExtensionSubjectAlternativeName) Descriptor() ([]byte, []int) {
	return file_extension_2_5_29_17_subject_alternative_name_proto_rawDescGZIP(), []int{0}
}

func (x *ExtensionSubjectAlternativeName) GetDnsNames() []string {
	if x != nil {
		return x.DnsNames
	}
	return nil
...
func (x *ExtensionSubjectAlternativeName) GetEmailAddresses() []string {
	if x != nil {
...
func (x *ExtensionSubjectAlternativeName) GetIpAddresses() []string {
	if x != nil {
...
func (x *ExtensionSubjectAlternativeName) GetUris() []string {
	if x != nil {
		return x.Uris
	}
	return nil
...
var file_extension_2_5_29_17_subject_alternative_name_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0x9e, 0x01, 0x0a, 0x1f, 0x45, 0x78, 0x74, 0x65, 0x6e, 0x73, 0x69,
	0x6f, 0x6e, 0x53, 0x75, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x41, 0x6c, 0x74, 0x65, 0x72, 0x6e, 0x61,
	0x74, 0x69, 0x76, 0x65, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x1b, 0x0a, 0x09, 0x64, 0x6e, 0x73, 0x5f,
	0x6e, 0x61, 0x6d, 0x65, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x09, 0x52, 0x08, 0x64, 0x6e, 0x73,
	...
	0x73, 0x12, 0x12, 0x0a, 0x04, 0x75, 0x72, 0x69, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x09, 0x52,
	0x04, 0x75, 0x72, 0x69, 0x73, 0x42, 0x16, 0x5a, 0x14, 0x70, 0x6c, 0x61, 0x79, 0x67, 0x72, 0x6f,
	0x75, 0x6e, 0x64, 0x2f, 0x70, 0x61, 0x72, 0x73, 0x65, 0x2f, 0x67, 0x65, 0x6e, 0x62, 0x06, 0x70,
...
var file_extension_2_5_29_17_subject_alternative_name_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_extension_2_5_29_17_subject_alternative_name_proto_goTypes = []interface{}{
	(*ExtensionSubjectAlternativeName)(nil), // 0: ExtensionSubjectAlternativeName
}
...
func file_extension_2_5_29_17_subject_alternative_name_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_extension_2_5_29_17_subject_alternative_name_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ExtensionSubjectAlternativeName); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
